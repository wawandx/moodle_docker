...
/**
 * Strings for component 'enrol_fee', language 'id', version '5.1'.
 *
 * @package     enrol_fee
 * @category    string
...
$string['instancedescription'] = 'Deskripsi instans';
$string['instancedescription_help'] = 'Deskripsi hanya ditampilkan di halaman \'Metode pendaftaran\' dan tidak ditampilkan kepada pengguna yang mendaftar dalam kursus.';
