...
/**
 * Strings for component 'enrol', language 'id', version '5.1'.
 *
 * @package     enrol
 * @category    string
...
$string['customwelcomemessage_help'] = 'Format yang diterima: Teks biasa atau format Moodle-otomatis. Tag HTML dan tag multibahasa juga diterima, serta penempatan berikut:
<ul>
<li>Nama kursus {$a->coursename}</li>
<li>Tautan ke halaman kursus {$a->courselink}</li>
<li>Tanggal mulai kursus {$a->coursestartdate}</li>
<li>Tautan ke halaman profil pengguna {$a->profileurl}</li>
<li>Surel pengguna {$a->email}</li>
