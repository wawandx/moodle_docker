...
/**
 * Strings for component 'error', language 'id', version '5.1'.
 *
 * @package     error
 * @category    string
...
$string['invaliddatetimebetween'] = '{$a->after} harus sebelum {$a->before}.';
$string['invaliddatetimemode'] = 'Mode tidak valid untuk filter yang dimodifikasi waktu: {$a}';
...
$string['rootdirpublic'] = 'Direktori root Moodle tidak boleh diakses publik. Harap konfigurasikan ulang server web Anda untuk menggunakan direktori `/public`.';
...
$string['wwwrootpublic'] = '$CFG->wwwroot di config.php salah. Seharusnya tidak diakhiri dengan /public.';
