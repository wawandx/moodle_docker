...
/**
 * Strings for component 'forum', language 'id', version '5.1'.
 *
 * @package     forum
 * @category    string
...
$string['charactercount'] = 'Jumlah karakter';
...
$string['digesttype'] = 'Tipe ringkasan';
...
$string['subscribedtoforum'] = 'Berlangganan ke {$a}';
...
$string['subscribetoforum'] = 'Berlangganan ke forum {$a}';
...
$string['trackedforforum'] = 'Pelacakan nyala untuk {$a}';
$string['trackforforum'] = 'Lacak postingan baru untuk forum {$a}';
...
$string['unsubscribedfromforum'] = 'Berhenti berlangganan dari {$a}';
...
$string['unsubscribefromforum'] = 'Berhenti berlangganan dari forum {$a}';
$string['unsubscribelink'] = 'Berhentikan berlangganan forum ini: {$a}';
$string['unsubscribeshort'] = 'Berhenti berlangganan';
$string['untrackedforforum'] = 'Pelacakan mati untuk {$a}';
$string['untrackforforum'] = 'Jangan lacak postingan baru untuk forum {$a}';
