...
class __Mustache_4efb7fcad1d1af71f1e51e6dcac1d74d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '<div class="form-filetypes-descriptions w-100" data-all-allowed-extensions="';
        $value = $this->resolveValue($context->find('allowedextensions'), $context);
