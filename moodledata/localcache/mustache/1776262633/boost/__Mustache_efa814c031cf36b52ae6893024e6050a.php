...
class __Mustache_efa814c031cf36b52ae6893024e6050a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block58aff3c3e6cfd05e202bbf6579939aa2'),
            ));
...
';
    ...
    private function section23127b8066806dcd5676f2f94d70fba0(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
';
    ...
    public function block58aff3c3e6cfd05e202bbf6579939aa2($context)
    {
        $indent = $buffer = '';
...
';
        ...
        $buffer .= $this->section23127b8066806dcd5676f2f94d70fba0($context, $indent, $value);
        $buffer .= $indent . '            ';
