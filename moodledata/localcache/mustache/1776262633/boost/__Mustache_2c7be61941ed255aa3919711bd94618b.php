...
class __Mustache_2c7be61941ed255aa3919711bd94618b extends Mustache_Template
{
...
';
        $buffer .= $indent . '        data-bs-auto-close="';
        $value = $context->find('autoclose');
        $buffer .= $this->sectionF8254c136fd05e2fdb40d62eaebaf1b4($context, $indent, $value);
        $value = $context->find('autoclose');
        if (empty($value)) {
...
';
    ...
    private function sectionF8254c136fd05e2fdb40d62eaebaf1b4(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        if (!is_string($value) && is_callable($value)) {
            ...
            foreach ($values as $value) {
                ...
                $value = $this->resolveValue($context->find('autoclose'), $context);
                $buffer .= ($value === null ? '' : call_user_func($this->mustache->getEscape(), $value));
                $context->pop();
            }
        }
