...
class __Mustache_a38d681fabf79633bd43871801dec628 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $indent . '
';
        $buffer .= $indent . '<div class="block-myoverview block-cards" data-region="myoverview">
';
...
';
        $buffer .= $indent . '            >
';
        $buffer .= $indent . '            <h4 class="h4 mt-3 mb-0">';
