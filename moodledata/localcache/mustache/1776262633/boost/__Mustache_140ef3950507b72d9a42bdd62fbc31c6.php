...
class __Mustache_140ef3950507b72d9a42bdd62fbc31c6 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/popover_region')) {
            $context->pushBlockContext(array(
                ...
                'headeractions' => array($this, 'block6b3434b5388a4b0117b020f3f7888d1e'),
...
';
    ...
    public function block6b3434b5388a4b0117b020f3f7888d1e($context)
    {
        $indent = $buffer = '';
