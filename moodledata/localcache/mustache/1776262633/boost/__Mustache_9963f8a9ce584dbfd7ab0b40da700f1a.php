...
class __Mustache_9963f8a9ce584dbfd7ab0b40da700f1a extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core/sticky_footer')) {
            $context->pushBlockContext(array(
                ...
                'stickycontent' => array($this, 'blockF2e1fe1cc82db2b23ada72eb22dfd6b5'),
            ));
...
';
    ...
    public function blockF2e1fe1cc82db2b23ada72eb22dfd6b5($context)
    {
        $indent = $buffer = '';
...
';
        $buffer .= $indent . '        </div>
';
        $buffer .= $indent . '        <div class="bulkcount" data-for="bulkcount" role="status">
';
        $buffer .= $indent . '            ';
        $value = $context->find('str');
