...
class __Mustache_f26633ec99fd16cf6da0f714affc3832 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'blockDfdc8becdbee0ec126366aba4642b491'),
            ));
...
';
    ...
    private function section3c111d6304514f1cd97d16843fb28e49(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        ...
        ';
            ...
            foreach ($values as $value) {
                ...
                if ($parent = $this->mustache->loadPartial('core/local/dropdown/status')) {
                    $context->pushBlockContext(array(
                        'buttonclasses' => array($this, 'block816f837415a8d4f3a2231dfb864c4d28'),
                    ));
                    $buffer .= $parent->renderInternal($context, $indent);
                    $context->popBlockContext();
                }
...
';
    ...
    public function block816f837415a8d4f3a2231dfb864c4d28($context)
    {
        $indent = $buffer = '';
        $buffer .= ' form-select dropdown-toggle ';
    
        return $buffer;
    }

    public function blockDfdc8becdbee0ec126366aba4642b491($context)
    {
        $indent = $buffer = '';
...
';
            ...
            $buffer .= $this->section3c111d6304514f1cd97d16843fb28e49($context, $indent, $value);
        }
        $value = $context->findDot('element.frozen');
