...
class __Mustache_4882f0effd49da94be1872a2d07cae93 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block1fab26f3c7cd47252391977c7acf685a'),
            ));
...
';
    ...
    public function block1fab26f3c7cd47252391977c7acf685a($context)
    {
        $indent = $buffer = '';
